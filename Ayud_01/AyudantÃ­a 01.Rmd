...
library(data.table) # data table es de las herramientas más rápidas y que sirven para funcionar eficientemente
library(titanic)
...
class(Titanic[,Age])
class(Titanic[,Survived]) # no existen muchas diferencias entre integer y numeric (integer se usa más que nada para menores procesamientos como 0 y 1)
